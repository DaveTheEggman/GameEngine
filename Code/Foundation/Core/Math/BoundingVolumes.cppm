...
export namespace foundation::core
{
    ...
    // ---- Projected-coverage LOD math (mesh-lod.md; shared with terrain chunk LOD) ----
    // Pure sphere-vs-camera math on core types, so RHI-free consumers (foundation.terrain,
    // a headless bake) use the SAME formula the renderer does - never formula #2.
    // foundation.render's mesh-facing LodCoverageFor/PickLodLevel/ApplyLodHysteresis are
