...
// Foundation::Fonts - foundation.fonts:font_manager partition (folded in from Fonts.IO 2026-09-05)
//
...
export module foundation.fonts:font_manager;

import foundation.core;
import :types;
import :interfaces;
import :backend_interfaces;
import :factories;
