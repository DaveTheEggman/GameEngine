// Raptor Core — Threading backend (classic header).
//
...
#ifndef RAPTOR_CORE_THREADING_BACKEND_H
#define RAPTOR_CORE_THREADING_BACKEND_H
...
#endif // RAPTOR_CORE_THREADING_BACKEND_H
