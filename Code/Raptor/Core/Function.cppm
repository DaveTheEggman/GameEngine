// Raptor Core — :function partition
//
...
export module raptor.core:function;
    ...
    public:
        ...
        Function(F&& callable, IAllocator& allocator = DefaultAllocator())
        {
            ...
            else
            {
                ...
                RAPTOR_ASSERT_MSG(memory != nullptr, "Function allocation failed");
        ...
        {
            RAPTOR_ASSERT_MSG(m_invoke != nullptr, "Called an empty Function");
