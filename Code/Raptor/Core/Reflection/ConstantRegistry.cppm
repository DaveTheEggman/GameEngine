// Raptor Core — :constant_registry partition
//
// A registry of named constants that aren't members of a struct — e.g.
// namespace-level math constants (raptor::core::kPi, kEpsilon). Per-type
...
export module raptor.core:constant_registry;
...
export namespace raptor::core
{
    ...
    public:
        ...
        {
            RAPTOR_ASSERT(index < m_constants.Size());
