// Raptor Core — :filesystem partition
//
...
export namespace raptor::core
{
    ...
    [[nodiscard]] inline Result<Array<byte>> ReadFile(const char* path, IAllocator& allocator = DefaultAllocator())
    {
    ...
    [[nodiscard]] inline Status WriteFile(const char* path, Span<const byte> data)
    {
