// Raptor Core — :iserializable partition
//
...
export module raptor.core:iserializable;
...
export namespace raptor::core
{
    ...
    {
        RAPTOR_OBJECT(ISerializable, Object)
    public:
    ...
    RAPTOR_DEFINE_OBJECT(ISerializable, "raptor::core")
}
