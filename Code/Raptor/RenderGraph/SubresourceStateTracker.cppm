// Raptor::RenderGraph — :state_tracker partition
//
...
export module raptor.rendergraph:state_tracker;
...
export namespace raptor::rendergraph
{
    ...
    public:
        SubresourceStateTracker(u32 mipCount, u32 layerCount, rhi::ResourceState initialState)
            : m_mipCount(Max(mipCount, 1u)), m_layerCount(Max(layerCount, 1u)), m_uniformState(initialState) {}
        ...
        {
            if (m_states.IsEmpty()) { return m_uniformState; }
        ...
        void InitFromStates(const Array<rhi::ResourceState>& states, rhi::ResourceState uniformFallback)
        {
