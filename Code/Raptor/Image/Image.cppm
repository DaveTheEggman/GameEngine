...
public:
    ...
    void Clear() {
        if (raptor::image::HasAlpha(m_format))
    ...
    [[nodiscard]] bool HasAlpha() const { return raptor::image::HasAlpha(m_format); }
    /// Number of channels in this image's pixel format.
    [[nodiscard]] i32 GetChannelCount() const { return static_cast<i32>(raptor::image::ChannelCount(m_format)); }
