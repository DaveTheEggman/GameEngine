/// Raptor::Animation — the `:sampler` partition.
///
...
export module raptor.animation:sampler;
...
inline void SampleClip(const AnimationClip& clip, const Skeleton& skeleton, f32 time, Span<BoneTransform> outPoses) {
...
inline void BlendPoses(Span<const BoneTransform> a, Span<const BoneTransform> b, f32 factor, Span<BoneTransform> out) {
...
inline void AdditivePoses(Span<const BoneTransform> base, Span<const BoneTransform> additive, f32 weight, Span<BoneTransform> out) {
