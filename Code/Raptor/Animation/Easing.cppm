/// Raptor::Animation — the `:easing` partition.
///
/// EasingType: a serializable enum mapping 1:1 to the core easing functions (raptor.core :easings).
...
export module raptor.animation:easing;
