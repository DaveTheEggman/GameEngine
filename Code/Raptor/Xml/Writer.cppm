...
export module raptor.xml:writer;
...
export namespace raptor::xml
{
    ...
    public:
        ...
        static void EscapeText(StringView text, String& output) { raptor::xml::EscapeText(text, output); }
        static void EscapeAttributeValue(StringView value, String& output) { raptor::xml::EscapeAttributeValue(value, output); }
