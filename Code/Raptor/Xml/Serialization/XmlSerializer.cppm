// Raptor::XmlSerialization — the `raptor.xml.serialization` module.
//
...
// (raptor.xml). Inspired by Sedulous.Serialization.Xml's DOM scheme (typed
// element tags + a `name` attribute), adapted to Raptor's leaner interface.
//
...
export module raptor.xml.serialization;
