...
export module raptor.xml:nodes;
...
export namespace raptor::xml
{
    ...
    public:
        ...
        {
            RAPTOR_ASSERT_MSG(child->m_parent == nullptr, "Node already has a parent");
            child->m_parent = this;
        ...
        void InsertBefore(XmlNode* newChild, XmlNode* refChild)
        {
            ...
            RAPTOR_ASSERT_MSG(refChild->m_parent == this, "Reference child is not a child of this node");
            RAPTOR_ASSERT_MSG(newChild->m_parent == nullptr, "New node already has a parent");
        ...
        {
            RAPTOR_ASSERT_MSG(child->m_parent == this, "Node is not a child of this node");
