...
export module raptor.vg:shapes;
...
export namespace raptor::vg
{
    ...
    public:
        ...
        static void BuildRoundedRect(Rect rect, CornerRadii radii, PathBuilder& builder)
        {
        ...
        static void BuildCircle(Vec2 center, f32 radius, PathBuilder& builder)
        {
            BuildEllipse(center, radius, radius, builder);
        }

        /// Build an ellipse path using 4 cubic Bezier curves.
        static void BuildEllipse(Vec2 center, f32 rx, f32 ry, PathBuilder& builder)
        {
        ...
        static void BuildRegularPolygon(Vec2 center, f32 radius, i32 sides, PathBuilder& builder)
        {
            if (sides < 3) return;
        ...
        /// Build a star shape.
        static void BuildStar(Vec2 center, f32 outerRadius, f32 innerRadius, i32 points, PathBuilder& builder)
        {
            if (points < 3) return;
    ...
    public:
        ...
        static void GenerateDashes(Span<const Vec2> points, bool closed, Span<const f32> pattern, f32 offset, Array<Array<Vec2>>& output)
        {
            ...
            for (usize i = 0; i < totalPoints; ++i)
            {
                ...
                while (edgeRemaining > 0.0001f)
                {
                    ...
                    const Vec2 nextPos = currentPos + edgeDir * step;
                    ...
                    if (isDash)
                    {
                        ...
                        Array<Vec2>& seg = output[static_cast<usize>(currentIdx)];
                        if (seg.IsEmpty())
