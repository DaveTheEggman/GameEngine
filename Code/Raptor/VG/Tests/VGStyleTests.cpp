...
TEST_CASE("style: solid fill returns same color")
{
    ...
    const Color32 c1 = ToColor32(fill.GetColorAt(Vec2{0,0}, Rect{0,0,100,100}));
    const Color32 c2 = ToColor32(fill.GetColorAt(Vec2{50,50}, Rect{0,0,100,100}));
...
{
    VGLinearGradientFill fill(Vec2{0,0}, Vec2{100,0});
    fill.AddStop(0, Color::Black);
    fill.AddStop(1, Color::White);

    const Color32 atStart = ToColor32(fill.GetColorAt(Vec2{0,0}, Rect{0,0,100,100}));
    const Color32 atEnd = ToColor32(fill.GetColorAt(Vec2{100,0}, Rect{0,0,100,100}));
    const Color32 atMid = ToColor32(fill.GetColorAt(Vec2{50,0}, Rect{0,0,100,100}));
...
TEST_CASE("style: linear gradient multi-stop")
{
    ...
    const Color32 atStart = ToColor32(fill.GetColorAt(Vec2{0,0}, Rect{}));
    const Color32 atMid = ToColor32(fill.GetColorAt(Vec2{50,0}, Rect{}));
    const Color32 atEnd = ToColor32(fill.GetColorAt(Vec2{100,0}, Rect{}));
...
{
    VGRadialGradientFill fill(Vec2{50,50}, 50);
    fill.AddStop(0, Color::White);
    fill.AddStop(1, Color::Black);

    const Color32 atCenter = ToColor32(fill.GetColorAt(Vec2{50,50}, Rect{}));
    const Color32 atEdge = ToColor32(fill.GetColorAt(Vec2{100,50}, Rect{}));
...
{
    VGConicGradientFill fill(Vec2{50,50}, 0);
    fill.AddStop(0, Color::Red);
    fill.AddStop(1, Color::Blue);

    const Color32 atRight = ToColor32(fill.GetColorAt(Vec2{100,50}, Rect{}));
    CHECK(atRight.r > 200);
    const Color32 atLeft = ToColor32(fill.GetColorAt(Vec2{0,50}, Rect{}));
