// Raptor::SceneEditor — the `raptor.scene.editor` module (tooling).
//
...
export module raptor.scene.editor;
...
inline Status SaveScene(Scene& scene, raptor::content::Instance& instance) {
    SceneDocument doc;
