/// Raptor::SceneSubsystem — `raptor.scene.subsystem`.
///
...
/// keeping the bridge here leaves raptor.scene runtime-free.

module;
#include "Core/Prelude.h"

export module raptor.scene.subsystem;
...
class SceneSubsystem final : public raptor::runtime::Subsystem {
public:
