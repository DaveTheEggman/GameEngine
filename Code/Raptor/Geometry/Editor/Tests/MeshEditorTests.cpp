...
namespace
{
    void RemoveTree()
    {
        FileDelete(u8"raptor_mesh_edit_db/cube.rasset");
        FileDelete(u8"raptor_mesh_edit_db/skinned.rasset");
        RemoveDirectory(u8"raptor_mesh_edit_db");
    }
}
...
TEST_CASE("mesh editor: cooks a StaticMeshAsset -> StaticMeshSource")
{
    ...
    RemoveTree();
    NativeFileSystem outMount(u8"raptor_mesh_edit_db");
    Guid id;
