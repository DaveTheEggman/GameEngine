/// Raptor::Geometry — `raptor.geometry`, the engine's runtime mesh format.
///
/// Distinct from raptor.model (the importer's representation of a loaded file): this
