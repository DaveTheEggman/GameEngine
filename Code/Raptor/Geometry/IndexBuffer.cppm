/// Raptor::Geometry — the `:index_buffer` partition.
///
...
export module raptor.geometry:index_buffer;
...
public:
    ...
    [[nodiscard]] u32 Get(u32 index) const {
        ...
        const u32 offset = index * IndexSize();
        if (m_format == Format::U16) {
            u16 v = 0; MemCopy(&v, m_data.Data() + offset, 2); return v;
        }
        u32 v = 0; MemCopy(&v, m_data.Data() + offset, 4); return v;
    }
