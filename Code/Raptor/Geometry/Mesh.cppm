/// Raptor::Geometry — the `:mesh` partition.
///
...
export module raptor.geometry:mesh;
...
class StaticMesh : public Object {
    RAPTOR_OBJECT(StaticMesh, Object)
public:
    String                   name;
...
class SkinnedMesh final : public StaticMesh {
    RAPTOR_OBJECT(SkinnedMesh, StaticMesh)
public:
...
RAPTOR_DEFINE_OBJECT(StaticMesh, "raptor::geometry")
RAPTOR_DEFINE_OBJECT(SkinnedMesh, "raptor::geometry")
