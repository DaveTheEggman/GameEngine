// Raptor::Fonts — :atlas_texture partition
//
...
export module raptor.fonts:atlas_texture;
...
export namespace raptor::fonts
{
    ...
    public:
        ...
        [[nodiscard]] static raptor::image::OwnedImageData* ExpandR8ToRGBA8(const IFontAtlas* atlas)
        {
            ...
            if (r8.Size() < pixelCount) { return nullptr; }
            ...
            return DefaultAllocator().New<raptor::image::OwnedImageData>(
                w, h, raptor::image::PixelFormat::RGBA8, Span<const u8>(rgba.Data(), rgba.Size()));
        }
    };
}
