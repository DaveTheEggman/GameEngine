...
public:
    ...
    Status Initialize() {
        ...
        rhi::PushConstantRange gpc{}; gpc.stages = rhi::ShaderStage::Vertex; gpc.offset = 0; gpc.size = sizeof(Mat4);
    ...
    void DeclareGeometry(rendergraph::RenderGraph& graph, rendergraph::RGHandle color, rendergraph::RGHandle depth,
                         const Mat4& viewProj, const debug::DebugDraw* global, const debug::DebugDraw* scene,
            ...
            [color, depth, vb, p, vpX, vpY, vpW, vpH, vpMat, dlN, ol0, olN, dt0, dtN, ot0, otN](rendergraph::PassBuilder& b) {
                ...
                b.SetExecute([vb, p, vpMat, dlN, ol0, olN, dt0, dtN, ot0, otN](rhi::RenderPassEncoder& rp) {
                    ...
                    const auto draw = [&](rhi::RenderPipeline* pipe, u32 count, u32 first) {
                        rp.SetPipeline(pipe);
                        rp.SetPushConstants(rhi::ShaderStage::Vertex, 0, sizeof(Mat4), &vpMat);
    ...
    void DeclareScreen(rendergraph::RenderGraph& graph, rendergraph::RGHandle color, const Mat4& viewProj,
...
private:
    ...
    void BuildScreenQuads(Array<debug::DebugTextVertex>& out, const debug::DebugDraw* d, const Mat4& viewProj, u32 vpW, u32 vpH) {
        if (d == nullptr) { return; }
        ...
        for (const debug::Debug2DCommand& cmd : d->Commands2D()) {
            ...
            if (cmd.kind == debug::Debug2DKind::Rect) {
    ...
    static void EmitQuad(Array<debug::DebugTextVertex>& out, f32 x, f32 y, f32 w, f32 h, f32 u0, f32 v0, f32 u1, f32 v1, u32 col) {
        const debug::DebugTextVertex tl{ Vec3{ x, y, 0 },         Vec2{ u0, v0 }, col };
        const debug::DebugTextVertex tr{ Vec3{ x + w, y, 0 },     Vec2{ u1, v0 }, col };
        const debug::DebugTextVertex br{ Vec3{ x + w, y + h, 0 }, Vec2{ u1, v1 }, col };
        const debug::DebugTextVertex bl{ Vec3{ x, y + h, 0 },     Vec2{ u0, v1 }, col };
