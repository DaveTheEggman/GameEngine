...
public:
    ...
    Status Initialize() {
        ...
        m_shaders->RegisterSource(u8"ao_gtao",  shaders::ShaderStage::Fragment, Concat(AoCommon(), GtaoGenPS()));
        m_shaders->RegisterSource(u8"ao_ssao",  shaders::ShaderStage::Vertex,   AoVS());
        m_shaders->RegisterSource(u8"ao_ssao",  shaders::ShaderStage::Fragment, Concat(AoCommon(), SsaoGenPS()));
