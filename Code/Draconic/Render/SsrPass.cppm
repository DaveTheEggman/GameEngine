...
export namespace draconic::render
{
    ...
    public:
        ...
        Status Initialize()
        {
            ...
            m_shaders->RegisterSource(u8"ssr_resolve", shaders::ShaderStage::Fragment,
                                      SsrResolvePS());
                 ...
                 pc](rendergraph::PassBuilder& b)
                {
                    ...
                    b.SetExecute(
                        [this, &graph, hdr, depth, normal, material, pc](rhi::RenderPassEncoder& rp)
                        {
                            ...
                            rp.SetPushConstants(rhi::ShaderStage::Fragment, 0, sizeof(SsrPushC),
                                                &pc);
                            rp.Draw(3, 1, 0, 0);
                        });
                });
