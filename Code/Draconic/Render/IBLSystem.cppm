...
public:
    ...
    Status Initialize() {
        ...
        m_shaders->RegisterSource(u8"ibl_procenv",  shaders::ShaderStage::Fragment, Concat(IblCommon(), IblProcEnvPS()));
        m_shaders->RegisterSource(u8"ibl_analytic", shaders::ShaderStage::Fragment, Concat(IblCommon(), IblAnalyticPS()));
        m_shaders->RegisterSource(u8"ibl_equirect", shaders::ShaderStage::Fragment, Concat(IblCommon(), IblEquirectPS()));
        m_shaders->RegisterSource(u8"ibl_cubemap",  shaders::ShaderStage::Fragment, Concat(IblCommon(), IblCubemapPS()));
        m_shaders->RegisterSource(u8"ibl_downsample",shaders::ShaderStage::Fragment, Concat(IblCommon(), IblDownsamplePS()));
        m_shaders->RegisterSource(u8"ibl_prefilter",shaders::ShaderStage::Fragment, Concat(IblCommon(), IblPrefilterPS()));
