...
export namespace draconic::render
{
    ...
    public:
        ...
        Status Initialize()
        {
            ...
            m_shaders->RegisterSource(u8"probe_blit_vs", shaders::ShaderStage::Vertex,
                                      ProbeBlitVS());
            m_shaders->RegisterSource(u8"probe_blit_ps", shaders::ShaderStage::Fragment,
                                      ProbeBlitPS());
                ...
                for (u32 face = 0; face < 6; ++face)
                {
                    graph.AddRenderPass(
                         ...
                         srcBG](rendergraph::PassBuilder& b)
                        {
                            ...
                            b.SetColorTarget(0, prefilteredH, rhi::LoadOp::Clear,
                                             rhi::StoreOp::Store, rhi::ClearColor::Black(), dst);
