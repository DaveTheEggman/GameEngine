...
TEST_CASE("style: solid fill returns same color")
{
    ...
    const Color32 c1 = ToColor32(fill.GetColorAt(Vector2{0,0}, Rectangle{0,0,100,100}));
    const Color32 c2 = ToColor32(fill.GetColorAt(Vector2{50,50}, Rectangle{0,0,100,100}));
...
{
    VGLinearGradientFill fill(Vector2{0,0}, Vector2{100,0});
    fill.AddStop(0, Color::Black);
    fill.AddStop(1, Color::White);

    const Color32 atStart = ToColor32(fill.GetColorAt(Vector2{0,0}, Rectangle{0,0,100,100}));
    const Color32 atEnd = ToColor32(fill.GetColorAt(Vector2{100,0}, Rectangle{0,0,100,100}));
    const Color32 atMid = ToColor32(fill.GetColorAt(Vector2{50,0}, Rectangle{0,0,100,100}));
...
TEST_CASE("style: linear gradient multi-stop")
{
    ...
    const Color32 atStart = ToColor32(fill.GetColorAt(Vector2{0,0}, Rectangle{}));
    const Color32 atMid = ToColor32(fill.GetColorAt(Vector2{50,0}, Rectangle{}));
    const Color32 atEnd = ToColor32(fill.GetColorAt(Vector2{100,0}, Rectangle{}));
...
{
    VGRadialGradientFill fill(Vector2{50,50}, 50);
    fill.AddStop(0, Color::White);
    fill.AddStop(1, Color::Black);

    const Color32 atCenter = ToColor32(fill.GetColorAt(Vector2{50,50}, Rectangle{}));
    const Color32 atEdge = ToColor32(fill.GetColorAt(Vector2{100,50}, Rectangle{}));
...
{
    VGConicGradientFill fill(Vector2{50,50}, 0);
    fill.AddStop(0, Color::Red);
    fill.AddStop(1, Color::Blue);

    const Color32 atRight = ToColor32(fill.GetColorAt(Vector2{100,50}, Rectangle{}));
    CHECK(atRight.r > 200);
    const Color32 atLeft = ToColor32(fill.GetColorAt(Vector2{0,50}, Rectangle{}));
...
TEST_CASE("style: ColorUtils interpolate stops boundary clamp")
{
    ...
    const Color32 before = ToColor32(ColorUtils::InterpolateStops(Span<const GradientStop>(stops, 2), 0.0f));
    const Color32 after = ToColor32(ColorUtils::InterpolateStops(Span<const GradientStop>(stops, 2), 1.0f));
