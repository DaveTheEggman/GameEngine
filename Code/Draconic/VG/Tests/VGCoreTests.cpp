...
TEST_CASE("vg.fills: solid and linear gradient")
{
    ...
    CHECK(NearlyEqual(solid.GetColorAt(Float2{ 10.0f, 10.0f }, Rectangle{ 0, 0, 100, 100 }), Color::Green));
    ...
    CHECK(NearlyEqual(grad.GetColorAt(Float2{ 5.0f, 0.0f }, Rectangle{ 0, 0, 10, 10 }), Color{ 0.5f, 0.5f, 0.5f, 1.0f }));
}
