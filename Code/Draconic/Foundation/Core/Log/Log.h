...
#define DRACONIC_LOG(level, category, ...) ::foundation::core::Logf((level), (category), __VA_ARGS__)
...
#define DRACONIC_LOG_TRACE(category, ...)                                                          \
    (true ? (void)0 : DRACONIC_LOG(::foundation::core::LogLevel::Trace, (category), __VA_ARGS__))
#define DRACONIC_LOG_DEBUG(category, ...)                                                          \
    (true ? (void)0 : DRACONIC_LOG(::foundation::core::LogLevel::Debug, (category), __VA_ARGS__))
#define DRACONIC_LOG_INFO(category, ...)                                                           \
    (true ? (void)0 : DRACONIC_LOG(::foundation::core::LogLevel::Info, (category), __VA_ARGS__))
#else
#define DRACONIC_LOG_TRACE(category, ...)                                                          \
    DRACONIC_LOG(::foundation::core::LogLevel::Trace, (category), __VA_ARGS__)
#define DRACONIC_LOG_DEBUG(category, ...)                                                          \
    DRACONIC_LOG(::foundation::core::LogLevel::Debug, (category), __VA_ARGS__)
#define DRACONIC_LOG_INFO(category, ...)                                                           \
    DRACONIC_LOG(::foundation::core::LogLevel::Info, (category), __VA_ARGS__)
#endif

#define DRACONIC_LOG_WARNING(category, ...)                                                        \
    DRACONIC_LOG(::foundation::core::LogLevel::Warning, (category), __VA_ARGS__)
#define DRACONIC_LOG_ERROR(category, ...)                                                          \
    DRACONIC_LOG(::foundation::core::LogLevel::Error, (category), __VA_ARGS__)
#define DRACONIC_LOG_FATAL(category, ...)                                                          \
    DRACONIC_LOG(::foundation::core::LogLevel::Fatal, (category), __VA_ARGS__)
