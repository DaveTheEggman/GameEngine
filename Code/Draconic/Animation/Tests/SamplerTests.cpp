...
{
    BoneTransform a[1] = {}; a[0].position = Float3{ 0, 0, 0 };  a[0].scale = Float3{ 1, 1, 1 };
    BoneTransform b[1] = {}; b[0].position = Float3{ 10, 0, 0 }; b[0].scale = Float3{ 3, 3, 3 };
    BoneTransform out[1] = {};
    ...
    BoneTransform base[1] = {}; base[0].position = Float3{ 1, 0, 0 }; base[0].scale = Float3{ 1, 1, 1 };
    BoneTransform add[1]  = {}; add[0].position  = Float3{ 0, 5, 0 }; add[0].scale  = Float3{ 1, 1, 1 };
