...
namespace
{
    ...
    void RemoveTree()
    {
        FileDelete(u8"draconic_content_test_db/materials/steel.rasset");
        FileDelete(u8"draconic_content_test_db/materials/steel.extra.bin");
        RemoveDirectory(u8"draconic_content_test_db/materials");
        RemoveDirectory(u8"draconic_content_test_db");
    }
}
...
TEST_CASE("content: write source resource, reopen, read back by guid and path")
{
    ...
    RemoveTree();
    NativeFileSystem mount(u8"draconic_content_test_db");
