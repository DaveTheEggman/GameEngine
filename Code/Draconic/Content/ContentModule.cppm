...
export namespace draconic::content
{
    ...
    inline Instance* Group::AddInstance(const Guid& id, StringView name, StringView typeNs,
                                        StringView typeName)
    {
    ...
    inline Instance* Group::CreateInstanceWithId(const Guid& id, StringView name,
                                                 const TypeInfo& primaryType)
    {
        if (Instance* existing = GetInstance(name))
        {
