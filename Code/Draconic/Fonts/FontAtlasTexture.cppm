...
export namespace draconic::fonts
{
    ...
    public:
        ...
        [[nodiscard]] static draconic::image::OwnedImageData* ExpandR8ToRGBA8(const IFontAtlas* atlas)
        {
            ...
            return DefaultAllocator().New<draconic::image::OwnedImageData>(
                w, h, draconic::image::PixelFormat::RGBA8, Span<const u8>(rgba.Data(), rgba.Size()));
        }
    };
}
