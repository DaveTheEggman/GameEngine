...
export namespace draconic::core
{
    ...
    public:
        ...
        [[nodiscard]] T& Front() const noexcept { DRACONIC_ASSERT(m_size > 0); return m_data[0]; }
        [[nodiscard]] T& Back() const noexcept { DRACONIC_ASSERT(m_size > 0); return m_data[m_size - 1]; }
