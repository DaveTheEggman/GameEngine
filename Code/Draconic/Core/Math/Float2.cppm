...
export module draconic.core:float2;
...
export namespace draconic::core
{
    ...
    struct Float2
    {
        ...
        constexpr Float2& operator+=(Float2 r) noexcept { x += r.x; y += r.y; return *this; }
        constexpr Float2& operator-=(Float2 r) noexcept { x -= r.x; y -= r.y; return *this; }
        constexpr Float2& operator*=(f32 s) noexcept { x *= s; y *= s; return *this; }
        constexpr Float2& operator/=(f32 s) noexcept { x /= s; y /= s; return *this; }
    ...
    [[nodiscard]] constexpr Float2 operator+(Float2 a, Float2 b) noexcept { return { a.x + b.x, a.y + b.y }; }
    [[nodiscard]] constexpr Float2 operator-(Float2 a, Float2 b) noexcept { return { a.x - b.x, a.y - b.y }; }
    [[nodiscard]] constexpr Float2 operator*(Float2 a, Float2 b) noexcept { return { a.x * b.x, a.y * b.y }; }
    [[nodiscard]] constexpr Float2 operator*(Float2 v, f32 s) noexcept { return { v.x * s, v.y * s }; }
    [[nodiscard]] constexpr Float2 operator*(f32 s, Float2 v) noexcept { return { v.x * s, v.y * s }; }
    [[nodiscard]] constexpr Float2 operator/(Float2 v, f32 s) noexcept { return { v.x / s, v.y / s }; }
    [[nodiscard]] constexpr bool operator==(Float2 a, Float2 b) noexcept { return a.x == b.x && a.y == b.y; }
    ...
    [[nodiscard]] constexpr f32 DistanceSquared(Float2 a, Float2 b) noexcept { return LengthSquared(b - a); }
    [[nodiscard]] inline f32 Distance(Float2 a, Float2 b) noexcept { return Length(b - a); }

    [[nodiscard]] constexpr Float2 Lerp(Float2 a, Float2 b, f32 t) noexcept { return a + (b - a) * t; }
