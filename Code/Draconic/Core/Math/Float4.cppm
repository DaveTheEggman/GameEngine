...
export module draconic.core:float4;
...
export namespace draconic::core
{
    ...
    struct Float4
    {
        ...
        constexpr Float4(f32 inX, f32 inY, f32 inZ, f32 inW) noexcept : x(inX), y(inY), z(inZ), w(inW) {}
        ...
        constexpr Float4& operator+=(Float4 r) noexcept { x += r.x; y += r.y; z += r.z; w += r.w; return *this; }
        constexpr Float4& operator-=(Float4 r) noexcept { x -= r.x; y -= r.y; z -= r.z; w -= r.w; return *this; }
        constexpr Float4& operator*=(f32 s) noexcept { x *= s; y *= s; z *= s; w *= s; return *this; }
    ...
    [[nodiscard]] constexpr Float4 operator+(Float4 a, Float4 b) noexcept { return { a.x + b.x, a.y + b.y, a.z + b.z, a.w + b.w }; }
    [[nodiscard]] constexpr Float4 operator-(Float4 a, Float4 b) noexcept { return { a.x - b.x, a.y - b.y, a.z - b.z, a.w - b.w }; }
    [[nodiscard]] constexpr Float4 operator*(Float4 v, f32 s) noexcept { return { v.x * s, v.y * s, v.z * s, v.w * s }; }
    [[nodiscard]] constexpr Float4 operator*(f32 s, Float4 v) noexcept { return { v.x * s, v.y * s, v.z * s, v.w * s }; }
    [[nodiscard]] constexpr Float4 Lerp(Float4 a, Float4 b, f32 t) noexcept { return a + (b - a) * t; }
    [[nodiscard]] constexpr bool operator==(Float4 a, Float4 b) noexcept
    {
        return a.x == b.x && a.y == b.y && a.z == b.z && a.w == b.w;
    }

    [[nodiscard]] constexpr f32 Dot(Float4 a, Float4 b) noexcept { return a.x * b.x + a.y * b.y + a.z * b.z + a.w * b.w; }
