...
export module draconic.core:float3;
...
export namespace draconic::core
{
    ...
    struct Float3
    {
        ...
        constexpr Float3& operator+=(Float3 r) noexcept { x += r.x; y += r.y; z += r.z; return *this; }
        constexpr Float3& operator-=(Float3 r) noexcept { x -= r.x; y -= r.y; z -= r.z; return *this; }
        constexpr Float3& operator*=(f32 s) noexcept { x *= s; y *= s; z *= s; return *this; }
        constexpr Float3& operator/=(f32 s) noexcept { x /= s; y /= s; z /= s; return *this; }
    ...
    [[nodiscard]] constexpr Float3 operator+(Float3 a, Float3 b) noexcept { return { a.x + b.x, a.y + b.y, a.z + b.z }; }
    [[nodiscard]] constexpr Float3 operator-(Float3 a, Float3 b) noexcept { return { a.x - b.x, a.y - b.y, a.z - b.z }; }
    [[nodiscard]] constexpr Float3 operator*(Float3 a, Float3 b) noexcept { return { a.x * b.x, a.y * b.y, a.z * b.z }; }
    [[nodiscard]] constexpr Float3 operator*(Float3 v, f32 s) noexcept { return { v.x * s, v.y * s, v.z * s }; }
    [[nodiscard]] constexpr Float3 operator*(f32 s, Float3 v) noexcept { return { v.x * s, v.y * s, v.z * s }; }
    [[nodiscard]] constexpr Float3 operator/(Float3 v, f32 s) noexcept { return { v.x / s, v.y / s, v.z / s }; }
    [[nodiscard]] constexpr Float3 operator/(Float3 a, Float3 b) noexcept { return { a.x / b.x, a.y / b.y, a.z / b.z }; }   // component-wise
    [[nodiscard]] constexpr bool operator==(Float3 a, Float3 b) noexcept { return a.x == b.x && a.y == b.y && a.z == b.z; }
    ...
    [[nodiscard]] constexpr Float3 Lerp(Float3 a, Float3 b, f32 t) noexcept { return a + (b - a) * t; }
