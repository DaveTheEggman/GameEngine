...
#define DRACONIC_LOG_DEBUG(category, ...)                                                          \
    DRACONIC_LOG(::draconic::core::LogLevel::Debug, (category), __VA_ARGS__)
#define DRACONIC_LOG_INFO(category, ...)                                                           \
    DRACONIC_LOG(::draconic::core::LogLevel::Info, (category), __VA_ARGS__)
#endif

#define DRACONIC_LOG_WARNING(category, ...)                                                        \
    DRACONIC_LOG(::draconic::core::LogLevel::Warning, (category), __VA_ARGS__)
#define DRACONIC_LOG_ERROR(category, ...)                                                          \
    DRACONIC_LOG(::draconic::core::LogLevel::Error, (category), __VA_ARGS__)
#define DRACONIC_LOG_FATAL(category, ...)                                                          \
    DRACONIC_LOG(::draconic::core::LogLevel::Fatal, (category), __VA_ARGS__)
