...
{
    const Float2 p = PopupPositioner::BestFit(Rectangle{ 100, 50, 80, 30 }, Float2{ 120, 40 }, Rectangle{ 0, 0, 800, 600 });
...
{
    const Float2 p = PopupPositioner::BestFit(Rectangle{ 100, 550, 80, 30 }, Float2{ 120, 40 }, Rectangle{ 0, 0, 800, 600 });
...
{
    const Float2 p = PopupPositioner::BestFit(Rectangle{ 750, 50, 80, 30 }, Float2{ 120, 40 }, Rectangle{ 0, 0, 800, 600 });
...
{
    const Float2 p = PopupPositioner::Below(Rectangle{ 50, 100, 100, 30 }, Float2{ 80, 40 }, Rectangle{ 0, 0, 800, 600 });
...
{
    const Float2 p = PopupPositioner::Above(Rectangle{ 50, 100, 100, 30 }, Float2{ 80, 40 }, Rectangle{ 0, 0, 800, 600 });
    CHECK(p.x == doctest::Approx(50));
...
{
    const Float2 p = PopupPositioner::Submenu(Rectangle{ 700, 50, 150, 200 }, Float2{ 120, 180 }, Rectangle{ 0, 0, 800, 600 });
