...
{
    core::Rectangle r = GravityHelper::Apply(Gravity::None, 400.0f, 300.0f, 100.0f, 50.0f, Thickness{});
...
{
    core::Rectangle r = GravityHelper::Apply(Gravity::Center, 400.0f, 300.0f, 100.0f, 50.0f, Thickness{});
...
{
    core::Rectangle r = GravityHelper::Apply(Gravity::Bottom | Gravity::Right, 400.0f, 300.0f, 100.0f, 50.0f, Thickness{});
...
{
    core::Rectangle r = GravityHelper::Apply(Gravity::Fill, 400.0f, 300.0f, 100.0f, 50.0f, Thickness{});
    CHECK(r.x == doctest::Approx(0.0f));
    CHECK(r.y == doctest::Approx(0.0f));
...
{
    core::Rectangle r = GravityHelper::Apply(Gravity::Center, 400.0f, 300.0f, 100.0f, 50.0f, Thickness{ 10.0f, 20.0f, 10.0f, 20.0f });
...
{
    core::Rectangle r = GravityHelper::Apply(Gravity::Fill, 400.0f, 300.0f, 100.0f, 50.0f, Thickness{ 10.0f, 20.0f, 30.0f, 40.0f });
