...
export namespace draconic::ui
{
    ...
    [[nodiscard]] constexpr KeyModifiers operator|(KeyModifiers a, KeyModifiers b) noexcept { return static_cast<KeyModifiers>(static_cast<u32>(a) | static_cast<u32>(b)); }
    [[nodiscard]] constexpr KeyModifiers operator&(KeyModifiers a, KeyModifiers b) noexcept { return static_cast<KeyModifiers>(static_cast<u32>(a) & static_cast<u32>(b)); }
    constexpr KeyModifiers& operator|=(KeyModifiers& a, KeyModifiers b) noexcept { a = a | b; return a; }
    /// True if `flag` is set in `value`.
    [[nodiscard]] constexpr bool HasFlag(KeyModifiers value, KeyModifiers flag) noexcept { return (static_cast<u32>(value) & static_cast<u32>(flag)) != 0u; }
    ...
    enum class KeyCode : u32
    {
        ...
        KeypadDivide = 84, KeypadMultiply = 85, KeypadMinus = 86,
        KeypadPlus = 87, KeypadEnter = 88,
        Keypad1 = 89, Keypad2 = 90, Keypad3 = 91,
        Keypad4 = 92, Keypad5 = 93, Keypad6 = 94,
        Keypad7 = 95, Keypad8 = 96, Keypad9 = 97,
        Keypad0 = 98, KeypadPeriod = 99,

        Application = 101, KeypadEquals = 103,
