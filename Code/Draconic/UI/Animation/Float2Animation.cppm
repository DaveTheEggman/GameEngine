...
export namespace draconic::ui
{
    ...
    {
    public:
        Float2Animation(Float2 from, Float2 to, f32 duration, Function<void(Float2)> setter, EasingFunction easing = nullptr)
    ...
    protected:
        ...
        {
            m_setter(Float2{ m_from.x + (m_to.x - m_from.x) * t,
                             m_from.y + (m_to.y - m_from.y) * t });
        }
