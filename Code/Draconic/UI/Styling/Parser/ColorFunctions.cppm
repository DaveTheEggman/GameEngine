...
export namespace draconic::ui
{
    struct ColorFunctions
    {
        ...
        [[nodiscard]] static Color Lighten(Color color, f32 amount) { return Palette::Lighten(color, amount); }

        /// Darken a color by amount (0-1).
        [[nodiscard]] static Color Darken(Color color, f32 amount) { return Palette::Darken(color, amount); }
