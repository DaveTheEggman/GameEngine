...
struct ModelVertex {
    ...
    constexpr ModelVertex(Float3 pos, Float3 nrm, Float2 uv, u32 col = 0xFFFFFFFF, Float4 tan = { 1, 0, 0, 1 })
...
struct SkinnedModelVertex {
    ...
    constexpr SkinnedModelVertex(Float3 pos, Float3 nrm, Float2 uv, u32 col, Float4 tan,
