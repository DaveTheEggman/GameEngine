...
export namespace draconic::scene
{
    ...
    namespace detail
    {
        ...
        inline void ComponentToBlob(ComponentManagerBase& manager, EntityHandle owner,
                                    Array<u8>& out)
        {
            MemoryStream buffer;
        ...
        inline void ComponentFromBlob(ComponentManagerBase& manager, EntityHandle owner,
                                      Span<const u8> blob)
        {
            MemoryStream buffer;
    ...
    namespace detail
    {
        ...
        inline void WritePrefabRecord(ISerializer& ar, Scene& scene,
                                      Scene::PendingPrefabInstance& d, bool text)
        {
        ...
        inline void ReadPrefabRecord(ISerializer& ar, Scene& scene,
                                     Scene::PendingPrefabInstance& pending, bool wireNested,
                                     bool text)
        {
    ...
    inline void
    SerializeScene(ISerializer& ar, Scene& scene, IStream* legacyProbe = nullptr,
    ...
    inline Status
    CapturePrefab(Scene& scene, EntityHandle root, IStream& out,
    ...
    [[nodiscard]] inline bool FindPrefabMember(Scene& scene, const Guid& entityId,
                                               PrefabMemberInfo& out)
    {
        bool found = false;
        scene.ForEachPrefabInstance(
            [&](Scene::PrefabInstanceState& state)
    ...
    [[nodiscard]] inline bool IsPrefabComponentOverridden(Scene& scene,
                                                          const PrefabMemberInfo& member,
                                                          ComponentManagerBase& manager)
    {
    ...
    inline UniquePtr<Scene::PendingPrefabInstance>
    ...
    inline Status CaptureInstanceAsTemplate(
    ...
    inline bool RevertPrefabInstance(Scene& scene, const Guid& rootEntityId,
    ...
    [[nodiscard]] inline Result<Array<byte>>
    TranscodeSceneStreamToBinary(IStream& in, Scene& scratch, bool includeSettings)
    {
