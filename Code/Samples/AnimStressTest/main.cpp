...
namespace
{
    ...
    class AnimStressTestApp final : public draconic::engine::runtime::DefaultApplication
    {
    public:
        ...
        void SpawnInstance(core::Float3 position)
        {
            ...
            if (m_model->skeleton && !m_clips.IsEmpty() && skinnedEntities.Size() > 0)
            {
                        ...
                        m_scene->GetSystem<draconic::engine::animation::SkeletalAnimationComponentManager>())
                {
                    ...
                    draconic::engine::animation::SkeletalAnimationComponent& a = anims->Add(modelRoot);
