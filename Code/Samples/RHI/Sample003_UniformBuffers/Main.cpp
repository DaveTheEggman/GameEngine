...
draconic::core::Status UniformBufferSample::OnInit() {
    ...
    rhi::BindGroupLayoutDesc bgld{}; bgld.entries = Span<const rhi::BindGroupLayoutEntry>(bglE, 1);
...
void UniformBufferSample::OnRender() {
    ...
    Float4x4 view  = Float4x4::LookAtRH(draconic::core::Float3{0, 1.5f, -3}, draconic::core::Float3{ 0, 0, 0}, draconic::core::Float3{ 0, 1, 0});
