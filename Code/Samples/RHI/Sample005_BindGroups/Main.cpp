...
public:
    ...
    draconic::core::StringView Title() const override { return u8"Sample005 - Multiple Bind Groups"; }
protected:
...
void BindGroupSample::OnRender() {
    ...
    Float4x4 view = Float4x4::LookAtRH(draconic::core::Float3{std::sin(camAngle)*camDist, 5.0f, -std::cos(camAngle)*camDist}, draconic::core::Float3{ 0,0,0}, draconic::core::Float3{0,1,0});
