...
public:
    ...
    draconic::core::StringView Title() const override { return u8"Sample007 - Instanced Rendering"; }
protected:
...
draconic::core::Status InstancingSample::OnInit() {
    using draconic::core::Status, draconic::core::Span, draconic::core::u8, draconic::core::f32, draconic::core::u32;
    ...
    if (m_device->CreateBuffer(instBd, m_instBuf) != draconic::core::ErrorCode::Ok) return draconic::core::ErrorCode::Unknown;
