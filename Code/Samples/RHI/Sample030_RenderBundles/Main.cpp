...
draconic::core::Status RenderBundlesSample::OnInit() {
    ...
    if (sf::CompileToModule(m_compiler, m_device, kShaderSource, ds::ShaderStage::Vertex,   u8"VSMain", u8"BundleVS", m_vs) != draconic::core::ErrorCode::Ok) return draconic::core::ErrorCode::Unknown;
    if (sf::CompileToModule(m_compiler, m_device, kShaderSource, ds::ShaderStage::Fragment, u8"PSMain", u8"BundlePS", m_ps) != draconic::core::ErrorCode::Ok) return draconic::core::ErrorCode::Unknown;
...
void RenderBundlesSample::OnRender() {
    ...
    if (bundle) {
        ...
        rp->ExecuteBundles(draconic::core::Span<dr::RenderBundle* const>(bundles, 1));
    }
    rp->End();
