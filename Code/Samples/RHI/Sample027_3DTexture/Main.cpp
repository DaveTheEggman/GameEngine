...
private:
    foundation::core::Status createVolumeTexture();
    foundation::core::Status createLUTTexture();
    ...
    static constexpr foundation::core::u32 kVolumeSize = 32;
    static constexpr foundation::core::u32 kLUTSize = 64;
...
foundation::core::Status Texture3DSample::OnInit()
{
    ...
    if (createVolumeTexture() != foundation::core::ErrorCode::Ok)
        return foundation::core::ErrorCode::Unknown;
    if (createLUTTexture() != foundation::core::ErrorCode::Ok)
        return foundation::core::ErrorCode::Unknown;
...
foundation::core::Status Texture3DSample::createVolumeTexture()
{
    using foundation::core::Status, foundation::core::Span, foundation::core::u8, foundation::core::u32;
    ...
    if (m_device->CreateTexture(td, m_volumeTexture) != foundation::core::ErrorCode::Ok)
        return foundation::core::ErrorCode::Unknown;
...
foundation::core::Status Texture3DSample::createLUTTexture()
{
    using foundation::core::Status, foundation::core::Span, foundation::core::u8, foundation::core::u32;
    ...
    if (m_device->CreateTexture(td, m_lutTexture) != foundation::core::ErrorCode::Ok)
        return foundation::core::ErrorCode::Unknown;

    rhi::TextureViewDesc tvd{};
    tvd.format = rhi::TextureFormat::RGBA8UnormSrgb;
    tvd.dimension = rhi::TextureViewDimension::Texture1D;
    if (m_device->CreateTextureView(m_lutTexture, tvd, m_lutView) != foundation::core::ErrorCode::Ok)
        return foundation::core::ErrorCode::Unknown;
