...
public:
    ...
    foundation::core::StringView Title() const override { return u8"Sample018 - Bindless Textures"; }
...
private:
    foundation::core::Status createTextures();
    void generatePixel(foundation::core::u32 texIndex, foundation::core::u32 x, foundation::core::u32 y,
                       foundation::core::u8* rgba);
    ...
    static constexpr foundation::core::u32 kTexSize = 64;
    static constexpr foundation::core::u32 kNumTextures = 4;
...
foundation::core::Status BindlessSample::OnInit()
{
    ...
    if (samples::framework::CompileToModule(m_compiler, m_device, kShader,
                                            ...
                                            u8"BindlessVS", m_vs) != foundation::core::ErrorCode::Ok)
        return foundation::core::ErrorCode::Unknown;
    if (samples::framework::CompileToModule(m_compiler, m_device, kShader,
                                            shaders::ShaderStage::Fragment, u8"PSMain",
                                            u8"BindlessPS", m_ps) != foundation::core::ErrorCode::Ok)
        return foundation::core::ErrorCode::Unknown;

    // Create 4 procedural textures with different patterns
    if (createTextures() != foundation::core::ErrorCode::Ok)
        return foundation::core::ErrorCode::Unknown;
    ...
    if (m_device->CreateBindGroupLayout(blBgld, m_bindlessBgl) != foundation::core::ErrorCode::Ok)
        return foundation::core::ErrorCode::Unknown;
    ...
    if (m_device->CreateBindGroup(blBgd, m_bindlessBg) != foundation::core::ErrorCode::Ok)
        return foundation::core::ErrorCode::Unknown;
    ...
    if (m_device->CreateBindGroupLayout(sBgld, m_samplerBgl) != foundation::core::ErrorCode::Ok)
        return foundation::core::ErrorCode::Unknown;
    ...
    if (m_device->CreateBindGroup(sBgd, m_samplerBg) != foundation::core::ErrorCode::Ok)
        return foundation::core::ErrorCode::Unknown;
...
foundation::core::Status BindlessSample::createTextures()
{
    using foundation::core::Status, foundation::core::Span, foundation::core::u8, foundation::core::u32;
    ...
    for (u32 t = 0; t < kNumTextures; ++t)
    {
        ...
        if (m_device->CreateTexture(td, m_textures[t]) != foundation::core::ErrorCode::Ok)
        {
...
void BindlessSample::generatePixel(foundation::core::u32 texIndex, foundation::core::u32 x,
                                   foundation::core::u32 y, foundation::core::u8* rgba)
{
    ...
    { // Green gradient with stripes
        auto g = static_cast<foundation::core::u8>(fx * 255.0f);
        bool stripe = (y % 16) < 8;
        rgba[0] = stripe ? 30 : 10;
        rgba[1] = stripe ? g : static_cast<foundation::core::u8>(g / 2);
        rgba[2] = stripe ? 50 : 30;
        rgba[3] = 255;
        break;
    }
    ...
    { // Blue circles
        ...
        rgba[0] = static_cast<foundation::core::u8>(rings * 60);
        rgba[1] = static_cast<foundation::core::u8>(rings * 100);
        rgba[2] = static_cast<foundation::core::u8>(rings * 255);
        rgba[3] = 255;
        break;
    }
    default:
    { // Yellow/purple diagonal
        ...
        rgba[0] = static_cast<foundation::core::u8>(diag * 255 + (1.0f - diag) * 120);
        rgba[1] = static_cast<foundation::core::u8>(diag * 220);
        rgba[2] = static_cast<foundation::core::u8>((1.0f - diag) * 200);
        rgba[3] = 255;
        break;
    }
    }
