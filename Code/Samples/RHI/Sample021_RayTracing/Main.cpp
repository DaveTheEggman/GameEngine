...
foundation::core::Status RayTracingSample::OnInit()
{
    ...
    if (samples::framework::CompileToModule(
            ...
            u8"RTShaderLib", u8"6_3", m_rtShaderModule) != foundation::core::ErrorCode::Ok)
    {
    ...
    // ---- Create BLAS vertex buffer (3 vertices * 12 bytes = 36 bytes) ----
    {
        ...
        bd.label = u8"BLAS_VB";
        if (m_device->CreateBuffer(bd, m_rtVertexBuffer) != foundation::core::ErrorCode::Ok)
            return foundation::core::ErrorCode::Unknown;
    }
    ...
    // Upload BLAS vertex data.
    {
        ...
        transfer->WriteBuffer(
            ...
            Span<const foundation::core::u8>(
                reinterpret_cast<const foundation::core::u8*>(kBlasVertexData), 36));
        transfer->Submit();
    ...
    // Fill instance data.
    {
        ...
        *reinterpret_cast<foundation::core::u64*>(ptr + 56) = m_blas->DeviceAddress();
...
void RayTracingSample::OnResize(foundation::core::u32 w, foundation::core::u32 h)
{
    using foundation::core::Status, foundation::core::Span;
