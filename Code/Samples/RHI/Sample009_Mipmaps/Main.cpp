...
draconic::core::Status MipmapSample::OnInit() {
    ...
    rhi::BarrierGroup bg{}; bg.textureBarriers = Span<const rhi::TextureBarrier>(&tb, 1);
    enc->Barrier(bg);
    ...
    sd.mipmapFilter = rhi::MipmapFilterMode::Linear; sd.maxLod = static_cast<draconic::core::f32>(mipCount);
    ...
    rhi::BindGroupDesc tBgd{}; tBgd.layout = m_texBgl; tBgd.entries = Span<const rhi::BindGroupEntry>(tBgE, 2);
...
void MipmapSample::OnRender() {
    ...
    Float4x4 view = Float4x4::LookAtRH(draconic::core::Float3{0, 2, 2}, draconic::core::Float3{ 0, 0, -5}, draconic::core::Float3{0,1,0});
    Float4x4 proj = Float4x4::PerspectiveFovRH(draconic::core::DegreesToRadians(60.0f), aspect, 0.1f, 100.0f);
