...
public:
    ...
    raptor::core::StringView Title() const override { return u8"Sample008 - Depth Buffer"; }
protected:
...
void DepthBufferSample::recreateDepth(raptor::core::u32 w, raptor::core::u32 h) {
    ...
    dr::TextureDesc td = dr::TextureDesc::DepthBuffer(dr::TextureFormat::Depth24PlusStencil8, w, h, 1, u8"DepthTex");
