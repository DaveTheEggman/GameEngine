...
protected:
    ...
    void OnResize(draconic::core::u32 /*w*/, draconic::core::u32 /*h*/) override { createRenderTargets(); }
...
void MRTSample::createRenderTargets() {
    ...
    rhi::BindGroupDesc bgd{}; bgd.layout = m_compBgl; bgd.entries = draconic::core::Span<const rhi::BindGroupEntry>(bgE, 3);
...
draconic::core::Status MRTSample::OnInit() {
    ...
    if (samples::framework::CompileToModule(m_compiler, m_device, kGBufShader, shaders::ShaderStage::Vertex,   u8"VSMain", u8"GBufVS", m_gbVs) != draconic::core::ErrorCode::Ok) return draconic::core::ErrorCode::Unknown;
    if (samples::framework::CompileToModule(m_compiler, m_device, kGBufShader, shaders::ShaderStage::Fragment, u8"PSMain", u8"GBufPS", m_gbPs) != draconic::core::ErrorCode::Ok) return draconic::core::ErrorCode::Unknown;
    if (samples::framework::CompileToModule(m_compiler, m_device, kCompShader, shaders::ShaderStage::Vertex,   u8"VSMain", u8"CompVS", m_compVs) != draconic::core::ErrorCode::Ok) return draconic::core::ErrorCode::Unknown;
    if (samples::framework::CompileToModule(m_compiler, m_device, kCompShader, shaders::ShaderStage::Fragment, u8"PSMain", u8"CompPS", m_compPs) != draconic::core::ErrorCode::Ok) return draconic::core::ErrorCode::Unknown;
    ...
    rhi::PipelineLayoutDesc gpld{}; if (m_device->CreatePipelineLayout(gpld, m_gbPl) != draconic::core::ErrorCode::Ok) return draconic::core::ErrorCode::Unknown;
    ...
    if (m_device->CreateRenderPipeline(grpd, m_gbPipe) != draconic::core::ErrorCode::Ok) return draconic::core::ErrorCode::Unknown;
    ...
    rhi::BindGroupLayoutDesc cBgld{}; cBgld.entries = Span<const rhi::BindGroupLayoutEntry>(cE, 3);
    ...
    rhi::PipelineLayoutDesc cpld{}; cpld.bindGroupLayouts = Span<rhi::BindGroupLayout* const>(cSets, 1);
    ...
    if (m_device->CreateRenderPipeline(crpd, m_compPipe) != draconic::core::ErrorCode::Ok) return draconic::core::ErrorCode::Unknown;
...
void MRTSample::OnRender() {
    ...
    rhi::RenderPassDesc rpd1{}; rpd1.colorAttachments.Add(ca2[0]); rpd1.colorAttachments.Add(ca2[1]);
    ...
    rhi::RenderPassDesc rpd2{}; rpd2.colorAttachments.Add(ca1);
