...
namespace pipeline{
    namespace
    {
        // ParseFloatList + ParseHarvestRecord (the shared harvest-record parse) now live in
        // script.pipeline - the record FORMAT is a shared cook convention, not Wren syntax.
