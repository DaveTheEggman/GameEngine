                                          ...
                                          pipeline::BuilderRegistry& builders)
    {
        ...
        server.RegisterTool(
            ...
            [s, bld](const JsonValue& /*args*/) -> ToolResult
            {
                ...
                vfs::NativeFileSystem sourcesMount(s->project->SourcesRoot().AsView(), foundation::core::DefaultAllocator());
                ...
                vfs::NativeFileSystem planSources(sourcesRoot.AsView(), foundation::core::DefaultAllocator());
