...
namespace editor
{
    ...
    void SoundCueEditorPage::CommitEdit(StringView mergeKey)
    {
        ...
        (void)Commands().Execute(UniquePtr<IEditorCommand>(
            Allocator().New<EditSoundCueCommand>(*this, mergeKey, m_undoBaseline,
                                                        after),
            Allocator()));
    ...
    RefPtr<audio::AudioClip> SoundCueEditorPage::LoadSlotClip(usize slot)
    {
        ...
        RefPtr<audio::AudioClip> clip = MakeRef<audio::AudioClip>(Allocator());
    ...
    UniquePtr<EditorPage> SoundCuePageFactory::CreatePage(EditorContext& context,
                                                          foundation::content::Instance& instance)
    {
        auto* page = editor::EditorRootAllocator().New<SoundCueEditorPage>(context, *m_host, instance);
