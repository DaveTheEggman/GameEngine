...
Remaining (P1+): tangent-handle dragging for Smooth/Broken points, the script
facade (spline.of: positionAt/tangentAt/length/closestPoint), then consumers -
path-follow first, scatter-along-spline, particle spline opcode, road extrusion.
