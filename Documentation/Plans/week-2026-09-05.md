...
- **P2 features**: cross-zone stitching/portals, dynamic obstacles
  (DetourTileCache + partial tile rebake - the BuildTileAt primitive it
  needs SHIPPED this week, see week-2026-08-29), NavBlocker volumes, MCP
  `nav_bake` tool (rides the MCP resume list). Terrain-as-bake-source is
  DONE (0c05ad89) and the bake is TILED since 2026-09-02 - do not re-plan
  either.
